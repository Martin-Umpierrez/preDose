...
#> # A tibble: 6 × 30
#>      ID   OCC    DD   AMT  TIME   POD    DV  EVID   CMT   MDV    II    SS Creatinine   SCR  eGFR ClCrea
#>   <dbl> <dbl> <dbl> <dbl> <dbl> <dbl> <dbl> <dbl> <dbl> <dbl> <dbl> <dbl>      <dbl> <dbl> <dbl>  <dbl>
#> 1     1     1   6    3000   168     7   0       1     1     1    12     1       5.3   469.  9.16   9.80
#> 2     1     1   6       0   168     7   9.4     0     2     0     0     0       5.3   469.  9.16   9.80
#> 3     1     2   6.5  3250   264    11   0       1     1     1    12     1       4.17  369. 12.1   12.5 
#> 4     1     2   6.5     0   264    11   8.4     0     2     0     0     0       4.17  369. 12.1   12.5 
#> 5     1     3   7.5  3750   360    15   0       1     1     1    12     1       3.56  315. 14.5   15.1 
#> 6     1     3   7.5     0   360    15   8.4     0     2     0     0     0       3.56  315. 14.5   15.1 
#> # ℹ 14 more variables: AGE <dbl>, SEX <dbl>, WT <dbl>, HCT <dbl>, CYP3A5 <dbl>, EXPRESSION <dbl>,
#> #   PDN_DOSE <dbl>, PDNXWT <dbl>, Heigth <dbl>, Height..m. <dbl>, BSA <dbl>, BMIcalc <dbl>, LBW <dbl>,
#> #   DMELITU <dbl>
```
...
#> 
#> Output (101 lines): 
#>   ID DD  amt time evid cmt mdv ii ss Creatinine    SCR  eGFR ClCrea AGE SEX EXPRESSION PDN_DOSE PDNXWT
#> 1  1  6 3000  168    1   1   1 12  1       5.30  468.6  9.16   9.80  49   0          0       55  1.138
#> 2  1  6    0  168    0   2   0  0  0       5.30  468.6  9.16   9.80  49   0          0       55  1.138
#> 3  2  6 3000  408    1   1   1 12  1       0.99   87.5 89.59  90.26  39   1          0       25  0.392
#> 4  2  6    0  408    0   2   0  0  0       0.99   87.5 89.59  90.26  39   1          0       25  0.392
#> 5  3 18 9000   72    1   1   1 12  1      14.99 1325.4  3.58   7.21  59   1          0       60  0.624
#> 6  3 18    0   72    0   2   0  0  0      14.99 1325.4  3.58   7.21  59   1          0       60  0.624
#>   Heigth Height..m.  BSA BMIcalc  LBW DMELITU   DV IPRED  PRED    CP  iCL   iV iKA EVID OCC POD  HCT   WT
#> 1    150       1.50 1.41    21.5 34.8       0  0.0  9.38  6.40  9.38 23.2  995 4.5    1   1   7 29.9 48.4
#> 2    150       1.50 1.41    21.5 34.8       0  9.4  9.38  6.40  9.38 23.2  995 4.5    0   1   7 29.9 48.4
#> 3    175       1.75 1.78    20.8 53.5       1  0.0  6.20  6.57  6.20 33.3 1043 4.5    1   1  17 29.0 63.7
#> 4    175       1.75 1.78    20.8 53.5       1  6.2  6.20  6.57  6.20 33.3 1043 4.5    0   1  17 29.0 63.7
#> 5    176       1.76 2.12    31.0 66.9       0  0.0 20.00 20.05 20.00 32.3 1276 4.5    1   1   3 25.0 96.1
#> 6    176       1.76 2.12    31.0 66.9       0 20.0 20.00 20.05 20.00 32.3 1276 4.5    0   1   3 25.0 96.1
#>   CYP3A5     ETA1      ETA2 OCC
#> 1      3 -0.32089  0.037986   1
#> 2      3 -0.32089  0.037986   1
#> 3      3  0.04676 -0.007338   1
#> 4      3  0.04676 -0.007338   1
#> 5      3  0.00228 -0.000231   1
#> 6      3  0.00228 -0.000231   1
#> 
...
#> Output (205 lines): 
#>   ID  DD  amt time evid cmt mdv ii ss Creatinine   SCR  eGFR ClCrea AGE SEX EXPRESSION PDN_DOSE PDNXWT
#> 1  1 6.0 3000  168    1   1   1 12  1       5.30 468.6  9.16    9.8  49   0          0       55  1.138
#> 2  1 6.0    0  168    0   2   0  0  0       5.30 468.6  9.16    9.8  49   0          0       55  1.138
#> 3  1 6.5 3250  264    1   1   1 12  1       4.17 368.7 12.07   12.5  49   0          0       30  0.620
#> 4  1 6.5    0  264    0   2   0  0  0       4.17 368.7 12.07   12.5  49   0          0       30  0.620
#> 5  2 6.0 3000  408    1   1   1 12  1       0.99  87.5 89.59   90.3  39   1          0       25  0.392
#> 6  2 6.0    0  408    0   2   0  0  0       0.99  87.5 89.59   90.3  39   1          0       25  0.392
#>   Heigth Height..m.  BSA BMIcalc  LBW DMELITU  DV IPRED PRED   CP  iCL   iV iKA EVID OCC POD  HCT   WT
#> 1    150       1.50 1.41    21.5 34.8       0 0.0  8.48 6.40 8.48 25.3  992 4.5    1   1   7 29.9 48.4
#> 2    150       1.50 1.41    21.5 34.8       0 9.4  8.48 6.40 8.48 25.3  992 4.5    0   1   7 29.9 48.4
#> 3    150       1.50 1.41    21.5 34.8       0 0.0  9.23 6.96 9.23 25.2  992 4.5    1   2  11 28.7 48.4
#> 4    150       1.50 1.41    21.5 34.8       0 8.4  9.23 6.96 9.23 25.2  992 4.5    0   2  11 28.7 48.4
#> 5    175       1.75 1.78    20.8 53.5       1 0.0  5.65 6.57 5.65 36.8 1192 4.5    1   1  17 29.0 63.7
#> 6    175       1.75 1.78    20.8 53.5       1 6.2  5.65 6.57 5.65 36.8 1192 4.5    0   1  17 29.0 63.7
#>   CYP3A5   ETA1   ETA2 OCC
#> 1      3 -0.234 0.0355   1
#> 2      3 -0.234 0.0355   1
#> 3      3 -0.234 0.0355   2
...
#>   Height..m.  BSA BMIcalc  LBW DMELITU  DV IPRED PRED   CP  iCL   iV iKA EVID OCC POD  HCT   WT CYP3A5
#> 1        1.5 1.41    21.5 34.8       0 0.0  7.72 6.40 7.72 27.6 1025 4.5    1   1   7 29.9 48.4      3
#> 2        1.5 1.41    21.5 34.8       0 9.4  7.72 6.40 7.72 27.6 1025 4.5    0   1   7 29.9 48.4      3
#> 3        1.5 1.41    21.5 34.8       0 0.0  8.40 6.96 8.40 27.5 1025 4.5    1   2  11 28.7 48.4      3
#> 4        1.5 1.41    21.5 34.8       0 8.4  8.40 6.96 8.40 27.5 1025 4.5    0   2  11 28.7 48.4      3
#> 5        1.5 1.43    22.3 35.3       0 0.0  9.73 8.07 9.73 27.4 1036 4.5    1   3  15 26.9 50.2      3
#> 6        1.5 1.43    22.3 35.3       0 8.4  9.73 8.07 9.73 27.4 1036 4.5    0   3  15 26.9 50.2      3
#>     ETA1   ETA2 OCC
#> 1 -0.148 0.0677   1
#> 2 -0.148 0.0677   1
#> 3 -0.148 0.0677   2
...
#> 6  1 7.5    0  360    0   2   0  0  0       3.56 315 14.49   15.1  49   0          0       20  0.398    150
#>   Height..m.  BSA BMIcalc  LBW DMELITU  DV IPRED PRED   CP  iCL   iV iKA EVID OCC POD  HCT   WT CYP3A5
#> 1        1.5 1.41    21.5 34.8       0 0.0  7.48 6.40 7.48 28.3 1016 4.5    1   1   7 29.9 48.4      3
#> 2        1.5 1.41    21.5 34.8       0 9.4  7.48 6.40 7.48 28.3 1016 4.5    0   1   7 29.9 48.4      3
#> 3        1.5 1.41    21.5 34.8       0 0.0  8.14 6.96 8.14 28.2 1016 4.5    1   2  11 28.7 48.4      3
#> 4        1.5 1.41    21.5 34.8       0 8.4  8.14 6.96 8.14 28.2 1016 4.5    0   2  11 28.7 48.4      3
#> 5        1.5 1.43    22.3 35.3       0 0.0  9.43 8.07 9.43 28.2 1028 4.5    1   3  15 26.9 50.2      3
#> 6        1.5 1.43    22.3 35.3       0 8.4  9.43 8.07 9.43 28.2 1028 4.5    0   3  15 26.9 50.2      3
#>     ETA1   ETA2 OCC
#> 1 -0.122 0.0593   1
#> 2 -0.122 0.0593   1
#> 3 -0.122 0.0593   2
...
#> 6  1 7.5    0  360    0   2   0  0  0       3.56 315 14.49   15.1  49   0          0       20  0.398    150
#>   Height..m.  BSA BMIcalc  LBW DMELITU  DV IPRED PRED   CP  iCL   iV iKA EVID OCC POD  HCT   WT CYP3A5
#> 1        1.5 1.41    21.5 34.8       0 0.0  7.65 6.40 7.65 27.9 1036 4.5    1   1   7 29.9 48.4      3
#> 2        1.5 1.41    21.5 34.8       0 9.4  7.65 6.40 7.65 27.9 1036 4.5    0   1   7 29.9 48.4      3
#> 3        1.5 1.41    21.5 34.8       0 0.0  8.32 6.96 8.32 27.8 1036 4.5    1   2  11 28.7 48.4      3
#> 4        1.5 1.41    21.5 34.8       0 8.4  8.32 6.96 8.32 27.8 1036 4.5    0   2  11 28.7 48.4      3
#> 5        1.5 1.43    22.3 35.3       0 0.0  9.65 8.07 9.65 27.7 1048 4.5    1   3  15 26.9 50.2      3
#> 6        1.5 1.43    22.3 35.3       0 8.4  9.65 8.07 9.65 27.7 1048 4.5    0   3  15 26.9 50.2      3
#>     ETA1   ETA2 OCC
#> 1 -0.139 0.0789   1
#> 2 -0.139 0.0789   1
#> 3 -0.139 0.0789   2
...
#> 6   6   2  240       7.236170  5.8  24.76155 24.76155 0.06131346
#> 7   6   2  241      14.361734 16.1 -10.79669 10.79669 0.01165684
#> 8   6   2  242      13.570430 15.5 -12.44884 12.44884 0.01549735
#> 9   6   2  248       9.305840  7.3  27.47726 27.47726 0.07550001
...
#> 3     4 -0.898     -10.1          8.34  25.8  32.2  38    66  
#> 4     5 -8.76      -18.5          1.02  25.9  35.1  52    66  
#> 5     6 -2.74      -14.5          9.07  30.6  36.1  33.3  53.8
```
...
#> 3     4 -0.898     -10.1          8.34  25.8  32.2  38    66   Han_etal
#> 4     5 -8.76      -18.5          1.02  25.9  35.1  52    66   Han_etal
#> 5     6 -2.74      -14.5          9.07  30.6  36.1  33.3  53.8 Han_etal
```
